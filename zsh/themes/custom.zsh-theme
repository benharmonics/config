...
setopt prompt_subst
PROMPT="${purple}%n%{$reset_color%}%{$reset_color%}\$(ruby_prompt_info)\$vcs_info_msg_0_${orange} ❯%{$reset_color%}${turquoise}❯%{$reset_color%}${limegreen}❯%{$reset_color%} "
RPROMPT="${limegreen}%3~%{$reset_color%}"
